...
class RuntimeInstaller {
    ...
    try {
      ...
      try {
        if (manifest.installMode === "bootstrap") {
          ...
          const extract = this.extract || (await import("@electron-internal/extract-zip")).default;
  ...
  async bootstrapRuntime(runtimeRoot, stagingRoot, manifest) {
    ...
    try {
      ...
      const extractZip = this.extract || (await import("@electron-internal/extract-zip")).default;
      await extractZip(assetPaths.get("uv"), { dir: uvExtractRoot });
